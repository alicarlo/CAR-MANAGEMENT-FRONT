...
@Component({
  selector: 'app-type-payments-modal',
  imports: [ButtonComponent, CommonModule, MatDialogModule, FormsModule, ReactiveFormsModule, MatIconModule],
  templateUrl: './type-payments-modal.component.html',
  styleUrl: './type-payments-modal.component.css'
})
export class TypePaymentsModalComponent {
  ...
  constructor(
    ...
    @Optional() public dialogRef: MatDialogRef<TypePaymentsModalComponent> | null, 
  ...
  save() {
    ...
    const methodMap = {
      registerTypePayments: this._TypePaymentsService.registerTypePayments.bind(this._TypePaymentsService),
      updateTypePayments:   this._TypePaymentsService.updateTypePayments.bind(this._TypePaymentsService),
    } as const;
    
    type MethodKey = keyof typeof methodMap; 

    const methodSelect: MethodKey =
      this.data.row === null ? 'registerTypePayments' : 'updateTypePayments';
